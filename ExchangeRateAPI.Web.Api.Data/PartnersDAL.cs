...
namespace ExchangeRateAPI.Web.Api.DAL
{
    public class PartnersDAL : IPartnersDAL
    {
        ...
        public PartnersDAL()
        {
            string relativePath = Path.Combine("WebApplication2", "Data", "Countries.json");
            string fullPath = Path.Combine(Directory.GetCurrentDirectory(), relativePath);
            var jsonData = File.ReadAllText(@"C:\Users\ShrutiKulkarni\source\repos\PangeaAPI\WxchangeRateAPI.Web.Api.Data\Data\PartnerRates.json");
